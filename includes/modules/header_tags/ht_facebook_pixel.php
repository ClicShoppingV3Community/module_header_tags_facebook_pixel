...
/*
  ...
  fbq(\'init\', \'' . MODULE_HEADER_TAGS_FB_PIXEL_ID . '\');
';
				$numpixels = (int)(\defined('MODULE_HEADER_TAGS_FB_PIXEL_NUMER') ? MODULE_HEADER_TAGS_FB_PIXEL_NUMER : 1);
				for ($i = 2; $i < $n = $numpixels +1; $i++) {
					if (\defined('MODULE_HEADER_TAGS_FB_PIXEL_ID_'.$i) && tep_not_null(\constant('MODULE_HEADER_TAGS_FB_PIXEL_ID_'.$i))) {
						$output .= '  fbq(\'init\', \'' . \constant('MODULE_HEADER_TAGS_FB_PIXEL_ID_'.$i+1) . '\');
';
					}
				}
*/
